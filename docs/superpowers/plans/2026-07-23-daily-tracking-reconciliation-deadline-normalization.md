...
- [ ] **Step 1: Add failing deadline normalization tests**
...
- [ ] **Step 3: Implement the minimal deadline normalizer**
...
- [ ] **Step 2: Add a failing API regression test for history deletion**
...
- [ ] **Step 4: Implement reconciliation in the daily tracking service**
...
- [ ] **Step 4: Mark this plan complete and commit only the plan**
